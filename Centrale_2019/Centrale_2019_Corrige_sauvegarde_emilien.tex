...
\textbf{Remarque : } On suppose que l'on doit utiliser la même structure d'asservissement qu'en III.A. Ainsi en manipulant le schéma bloc on obtient : 
...
\sbEntree{E0}
\sbComp[4]{c2}{E0}
\sbRelier[$C_{ext}(p)$]{E0}{c2}
\sbBloc[1]{b2}{$K'_1$}{c2}
\sbRelier{c2}{b2}
\sbBloc[3]{b4}{$T(p)$}{b2}
\sbRelier[]{b2}{b4}
\sbSortie[4]{S}{b4}
\sbRelier[\^{C}$_{ext}(p)$]{b4}{S}
...
\dfrac{K'_1}{J_{eq}\cdot p^2+K'_2\cdot p+K'_1}=\dfrac{1}{1+\dfrac{K'_2}{K'_1}+\dfrac{J_{eq}}{K'_1}p^2}
\end{align*}

Par identification et avec ce qu'impose la cahier des charges.

\begin{align*}
\left\{
\begin{array}{c}
\omega'_0=\sqrt{K'_1}{J_{eq}}=5\omega_0\\
\\
\xi=\dfrac{\omega'_0}{2}\dfrac{K'_2}{K'_1}=\dfrac{1}{2}\sqrt{sqrt{K'_1}{J_{eq}}}\dfrac{K'_2}{K'_1}=1
\end{array}
\right.
\end{align*}
